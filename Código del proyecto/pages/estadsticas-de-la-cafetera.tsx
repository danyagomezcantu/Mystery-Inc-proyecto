...
import styles from "./estadsticas-de-la-cafetera.module.css";

const EstadsticasDeLaCafetera: NextPage = () => {
  ...
  return (
    <div className={styles.estadsticasDeLaCafetera}>
      ...
      <img
        className={styles.estadsticasDeLaCafeteraChild}
        alt=""
        src="/frame-63.svg"
      />
    </div>
...
export default EstadsticasDeLaCafetera;
